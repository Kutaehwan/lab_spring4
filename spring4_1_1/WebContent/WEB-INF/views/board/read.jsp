...
if (boardDetail != null) {
	...
	bs_file = String.valueOf(boardDetail.get(0).get("BS_FILE"));
...
<script type="text/javascript">
	...
	function updateForm() {
		...
		$('#dlg_upd').dialog({
		    ...
		    closed: false,
		    cache: false,
		    href: 'updateForm.jsp?bm_title=<%=bm_title%>&bm_writer=<%=bm_writer%>&bm_content=<%=bm_content%>&bm_no=<%=bm_no%>&bm_group=<%=bm_group%>&bm_pos=<%=bm_pos%>&bm_step=<%=bm_step%>',
		    modal: true
		});
	}
...
MultipartRequest  => cos.jar
 -->
		<form id="board_ins" method="post" enctype="multipart/form-data" action="./boardInsert.sp4">
			...
			<!-- 	<input type="hidden" name="bs_file" value=""> -->
			<!-- <form id="f_boardAdd"> -->
			<table>
				<tr>
	...
	<!-- [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[ 글 삭제 화면 시작 ]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]] -->
	<div id="dlg_boardDel" title="비밀번호 확인" class="easyui-dialog" style="width: 600px; height: 400px; padding: 10px"
		data-options="closed:'true'">
		<div style="margin-bottom">
			<input class="easyui-textbox" id="user_pw" name="user_pw" label="비밀번호" labelPosition="top"/>
		</div>
		<a href="javascript:boardDelAction()" class="easyui-link" iconCls="icon-ok" style="width:90px">확인</a>
		<a href="javascript:boardDelClose()" class="easyui-link" iconCls="icon-cancel" style="width:90px">닫기</a>
	</div>
	<!-- [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[ 글 삭제 화면 끝 ]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]] -->
